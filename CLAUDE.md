...
- В векторе снапшота 27 признаков, включая `prematch_prior` и 8 pre-match разниц.
  Рошана в векторе нет — `GetLiveLeagueGames` не отдаёт ни числа убийств, ни владельца
  аегиса, а STRATZ не отдаёт рошановских событий вовсе (см. инвариант 2).
